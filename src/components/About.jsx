      ...
      <Grid container spacing={1.8}>
        ...
        <Grid item xs={6}>
          <Box className={classes.box4} justifyContent="flex-start">
            ...
            >
              Hey, I am Amrit Satpathy currently pursuing B.Tech in Computer
              Science. I have always been passionate towards technology. If you
              do not find me with my laptop you would probably find me sleeping.
              I firmly believe hardwork and perseverance can help you achieve
              any goal in life.
            </Typography>
          </Box>
        </Grid>
        ...
        <Grid item xs={12}>
          ...
          >
            ...
            >
              Scored 93.4% in CBSE board exam in science <p></p>
            </Typography>
          </Box>
          <Box
            fontWeight="fontWeightBold"
          ...
          >
            ...
            >
              Currently pursuing BTech in computer science from Vellore
              Institute of Technology<p></p>
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={12}>
          ...
          >
            ...
            >
              Worked on automating replies to client mails using deep neural
              network <p></p>
            </Typography>
          </Box>
          <Box
